...
public class Day1 extends Day<Integer> {
	 ...
	 * - she attaches something to your wrist - "that will let you fix the changes
	 * with no such propagation delay. It's configured to send you 500 years further
	 * into the past every few days; that was the best we could do on such short
	 * notice."
	 * 
	 ...
	 * is found, and that duplicates might be found while in the middle of
	 * processing the list.
	 * 
