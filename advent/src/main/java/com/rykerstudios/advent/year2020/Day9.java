...
public class Day9 extends Day<Long> {
	 ...
	 * the two numbers in the pair must be different. <br/>
	 * 
	 ...
	 * previous 25 numbers. <br/>
	 * 65 would not be valid, as no two of the available numbers sum to it. <br/>
	...
	@Override
	public Long part1() {
		final XmasCipher cipher = new XmasCipher(25, getLines());
		return cipher.findAnomaly();
	}
	...
	public Long part2() {
		final XmasCipher cipher = new XmasCipher(25, getLines());
		return cipher.findWeakness(getExpectedPart1());
	}
