...
public class Day12 extends Day<Long> {
	 ...
	 * 
	 * Action N means to move north by the given value. <br/>
	 * Action S means to move south by the given value. <br/>
	 * Action E means to move east by the given value. <br/>
	 * Action W means to move west by the given value. <br/>
	 * Action L means to turn left the given number of degrees. <br/>
	 * Action R means to turn right the given number of degrees. <br/>
	 ...
	 * east) to east 10, north 0. <br/>
	 * N3 would move the ship 3 units north to east 10, north 3. <br/>
	 * F7 would move the ship another 7 units east (because the ship is still facing
	 * east) to east 17, north 3. <br/>
	 * R90 would cause the ship to turn right by 90 degrees and face south; it
	 * remains at east 17, north 3. <br/>
	 * F11 would move the ship 11 units south to east 17, south 8. <br/>
	 * 
	...
	@Override
	public Long part1() {
		final FerryNavigation ferry = new FerryNavigation(getLines(), false);
		ferry.moveAll();
		return ferry.getDistanceFromOrigin();
	}
	 ...
	 * 
	 * Action N means to move the waypoint north by the given value. <br/>
	 * Action S means to move the waypoint south by the given value. <br/>
	 * Action E means to move the waypoint east by the given value. <br/>
	 * Action W means to move the waypoint west by the given value. <br/>
	 * Action L means to rotate the waypoint around the ship left
	 * (counter-clockwise) the given number of degrees. <br/>
	 * Action R means to rotate the waypoint around the ship right (clockwise) the
	 * given number of degrees. <br/>
	 ...
	 * units east and 1 unit north of the ship. <br/>
	 * N3 moves the waypoint 3 units north to 10 units east and 4 units north of the
	 * ship. The ship remains at east 100, north 10. <br/>
	 ...
	 * units east and 4 units north of the ship. <br/>
	 ...
	 * units east and 10 units south of the ship. <br/>
	 * 
	...
	@Override
	public Long part2() {
		final FerryNavigation ferry = new FerryNavigation(getLines(), true);
		ferry.moveAll();
		return ferry.getDistanceFromOrigin();
	}
