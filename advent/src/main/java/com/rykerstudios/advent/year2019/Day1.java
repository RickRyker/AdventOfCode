...
public class Day1 extends Day<Integer> {
	...
	public int calcFuelWithFuel(int mass) {
		int total = 0;
		final int fuel = this.calcFuel(mass);
		if (fuel > 0) {
			total += fuel;
			total += calcFuelWithFuel(fuel);
		}
		return total;
	}
	...
	// So, the total fuel required for a module of mass 1969 is 654 + 216 + 70 + 21
	// + 5 = 966.
